            ...
            <nav className="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <div className="flex">
                                ...
                                <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                    ...
                                    <NavLink href={route('dashboard')} active={route().current('supportedLink')}>
                                        Supported Sites
                                    </NavLink>
                                </div>
                            </div>
                            ...
                            <div className="ml-3 relative">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        ...
                                        <Dropdown.Link href={route('profile.edit')}>Website</Dropdown.Link>
                                        <Dropdown.Link href={route('profile.edit')}>Manga</Dropdown.Link>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('dashboard')} active={route().current('supportedLink')}>
                            Supported Link
                        </ResponsiveNavLink>
                    </div>
